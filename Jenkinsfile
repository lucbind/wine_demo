   ...
   stages {
        ...
        stage('Get Wallet') {
                ...
                script {
                    ...
                    env.identifier_clone= sh "oci search resource free-text-search --text ${dbname}01 --raw-output --query \"data.items[?contains(\"resource-type\",\'AutonomousDatabase\')].\"identifier\"|[0]\""     
